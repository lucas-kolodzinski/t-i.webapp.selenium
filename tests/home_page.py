...
class HomePageElements(EnvironmentSetup):
    ...
    def test_1_verify_home_page_header(self):
    ...
    def test_4_verify_hyperreferences(self):
    ...
    def test_5_verify_page_footer(self):
        test_object = HomePage(self.driver)
    ...
    def test_6_verify_image_link(self):
        test_object = HomePage(self.driver)
